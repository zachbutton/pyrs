---
name: pyrs-scan
description: "Invoke pyrs-foundation first. Analyze a pyramid and its full lineage for structural gaps, under-specified areas, and missing leaves. Triggered by ::scan P where P is an @-prefixed pyramid reference."
---
...
8. **Hand off to the change flow** — once the user decides which gaps to address, route them to the appropriate command (`::spec` for new or revised pyramids). Do **NOT** create or modify pyramids directly — the scan command surfaces gaps and connects the user to the right command, nothing more.
